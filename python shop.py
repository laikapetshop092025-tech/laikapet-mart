...
# --- 4. DASHBOARD (ALL BOXES, DAILY DATE, MONTHLY NAME & GRAPH RESTORED) ---
if menu == "📊 Dashboard":
...
# --- 5. BILLING (REDEEM, REFERRAL & DAILY LIST RESTORED) ---
elif menu == "🧾 Billing":
...
# --- 6. LIVE STOCK (RED ALERT & DOWNLOAD RESTORED) ---
    ...
    if not i_df.empty:
        ...
        st.divider(); st.download_button("📥 Download Stock List", stock.to_csv(index=False), "order.csv")

# --- 7. PURANA FEATURES (PET, KHATA, LOYALTY, ADMIN, EXPENSE, PURCHASE RESTORED) ---
