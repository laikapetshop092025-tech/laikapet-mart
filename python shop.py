...
if menu == "📊 Dashboard":
    ...
    # Financial Logic (With Safety Checks to fix IndexError)
    ...
    # Total Purchase Logic (Fixing Photo 2 & 4 Error)
    pc = 0; po = 0
    ...
    # Metrics Reports (Sale, Purchase, Expense, Profit)
