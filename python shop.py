...
if menu == "📊 Dashboard":
    ...
    # FIXED: Ismein se filter hata diya hai taaki Dashboard par purana aur naya 9000 ka purchase dikhe
...
# --- 5. BAAKI SECTIONS (100% ORIGINAL WORD-TO-WORD) ---
elif menu == "🧾 Billing":
    ...
    d_df = load_data("Dues")
    if not d_df.empty:
        st.divider(); st.subheader("📑 Today's History")
