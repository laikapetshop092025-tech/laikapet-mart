...
# --- 4. DASHBOARD (ALL LOGICS + MONTHLY REPORT) ---
if menu == "📊 Dashboard":
    ...
    c1, c2, c3, c4 = st.columns(4); c1.metric("Sale", f"₹{ts_d}"); c2.metric("Purchase", f"₹{tp_d}"); c3.metric("Expense", f"₹{te_d}"); c4.metric("Profit", f"₹{tprof_d}")
...
# --- BAAKI ALL TABS (WORD-TO-WORD ORIGINAL) ---
elif menu == "🧾 Billing":
    st.header("🧾 Billing")
